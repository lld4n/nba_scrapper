...
|             | `api/players/:alphabet`                     | Возвращает список игроков по буквам алфавита<br>[reference](https://www.basketball-reference.com/players/a/)<br><br>`masalphabet`                                                                                                                                 |
|             | `api/players/:alphabet/:path/info`          | Возвращает общую информацию о игроке<br>[reference](https://www.basketball-reference.com/players/b/bryanko01.html)<br><br>`masalphabet`                                                                                                                           |
|             | `api/players/:alphabet/:path/pages/:key`    | Возвращает информацию постранично<br>[reference](https://www.basketball-reference.com/players/b/bryanko01.html)<br><br>`masalphabet`                                                                                                                              |
|             | `api/players/:alphabet/:path/splits/:key`   | Возвращает информацию о сплитах игрока<br>[reference](https://www.basketball-reference.com/players/b/bryanko01/splits/)<br>[reference](https://www.basketball-reference.com/players/b/bryanko01/splits/2001)<br><br>`masalphabet`                                 |
|             | `api/players/:alphabet/:path/gamelog/:key`  | Возвращает информацию о геймлогах игрока<br>[reference](https://www.basketball-reference.com/players/b/bryanko01/gamelog-playoffs-advanced/)<br>[reference](https://www.basketball-reference.com/players/b/bryanko01/gamelog-advanced/1998/)<br><br>`masalphabet` |
|             | `api/players/:alphabet/:path/shooting/:key` | Возвращает информацию о бросках игрока<br>[reference](https://www.basketball-reference.com/players/b/bryanko01/shooting/2002)<br><br>`masalphabet`                                                                                                                |
|     `teams` |                                             |                                                                                                                                                                                                                                                                   |
...
|             | `api/teams/:key/logos`                      | Возвращает логотипы команды<br>[reference](https://www.sportslogos.net/logos/list_by_team/3786/Brooklyn_Nets/)<br><br>`mascommands`                                                                                                                               |
|             | `api/teams/:key/pages/:path`                | Возвращает страницы с информацией о команде<br>[reference](https://www.basketball-reference.com/teams/NJN/stats_basic_totals.html)<br><br>`masteamspages`                                                                                                         |
|             | `api/teams/:key/years/:year/:path`          | Возвращает информацию о определенном сезоне<br>[reference](https://www.basketball-reference.com/teams/BRK/2023.html)<br><br>`masteamspages`                                                                                                                       |
| `boxscores` |                                             |                                                                                                                                                                                                                                                                   |
...
|             | `api/leagues/pages/:path`                   | Возвращает информацию с разных страниц связанных с сезонами<br>[reference](https://www.basketball-reference.com/leagues/NBA_stats_per_game.html)<br><br>`masleaguespages`                                                                                         |
|             | `api/leagues/years/:year/:path`             | Возвращает информацию о определенном сезоне<br>[reference](https://www.basketball-reference.com/leagues/NBA_2023.html)<br><br>`masleaguespages`                                                                                                                   |
|     `draft` |                                             |                                                                                                                                                                                                                                                                   |
...
|             | `api/playoffs/years/:year/:path`            | Возвращает информацию об определенном плей-оффе<br>[reference](https://www.basketball-reference.com/playoffs/NBA_2023.html)<br><br>`masplayoffsyears`                                                                                                             |
...
|             | `api/playoffs/pages/:path`                  | Возвращает информацию с разных страниц о плей-оффе<br>[reference](https://www.basketball-reference.com/playoffs/2023-nba-eastern-conference-first-round-knicks-vs-cavaliers.html)<br><br>`masplayoffsfinals`                                                      |
|   `allstar` |                                             |                                                                                                                                                                                                                                                                   |
...
|             | `api/allstar/meta/:path`                    | Возвращает метаинформацию об определенном матче всех звезд<br>[reference](https://www.basketball-reference.com/allstar/NBA_2023.html)<br><br>`masallstarlogos`                                                                                                    |
